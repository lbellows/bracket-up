...
PACKAGE=com.bracketup.app
# The home screen's empty state, which a fresh install always shows.
EXPECTED_TEXT="No tournaments yet"
TIMEOUT_SECONDS=90
...
echo "Launched, rendered the home screen, and did not crash."
